...
<body>
    ...
    <div class="nav_top">
        ...
        <a href="/compiled_MODULE-1/Module2/php/dis_board.php" id="back" style="text-decoration: none; float:right;">Go Back to Discussion</a>
    ...
    <div class="background_calendar">
        <script>
            ...
            $(document).ready(function(){
                var calendar = $('#kss3').fullCalendar({
